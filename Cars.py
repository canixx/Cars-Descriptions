...
class Mercedes(Cars):
    def __init__(self,model,color,weight,year,country,current_speed,current_fuel,fuel_type,brake_type,price,register_no,sunroof_status="OFF"):
        Cars.__init__(self,model,color,weight,year,country,current_speed,current_fuel,fuel_type,brake_type,price,register_no)
        #Sadece Mercedes classında olan bir özellik ekledim
    ...
    #Sadece Mercedes classı içinde kullanabileceğimz bir method
...
class Tesla(Cars):
    def __init__(self,model,color,weight,year,country,current_speed,current_fuel,fuel_type,brake_type,price,register_no,autopilot_mode = "OFF"):
        Cars.__init__(self,model,color,weight,year,country,current_speed,current_fuel,fuel_type,brake_type,price,register_no)
...
merso = Mercedes("G63 AMG","Black",2460,2022,"Germany",40,30,"Diesel","Hydraulic",15450000 ,200444008)
print(merso.show_speed())
print(merso.speed_up())
print(merso.show_speed())
merso.close_sunroof()